...
if __name__ == '__main__':
    ...
    net  = DeformConv3d(1, 3, kernel_size=3, stride=1, padding=1, bias=False).cuda()
    y = net(x)
    # print(y)
    print(time.time()-t)
    print(len(y))
# net  = DeformConv3d(in_planes, out_planes, kernel_size=3, stride=1, padding=1, bias=False)