...
from timm.layers import DropPath, to_2tuple, trunc_normal_,to_3tuple
...
class SMT(nn.Module):
    def __init__(self, img_size=96, in_chans=1, num_classes=15, embed_dims=[64, 128, 256, 512],
                 ...
                 norm_name: Union[Tuple, str] = "instance", depths=[2, 2, 8, 1], ca_attentions=[1, 1, 1, 0], num_stages=4, head_conv=3, expand_ratio=2, **kwargs):
        super().__init__()
