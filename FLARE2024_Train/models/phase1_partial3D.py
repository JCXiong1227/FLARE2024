...
class FasterNet(nn.Module):
    ...
    def __init__(self,
                 ...
                 patch_stride=4, 
                 patch_size2=2,  # for subsequent layers downsamplingfeature_dim
                 patch_stride2=2,
                 patch_norm=True,
        ...
        self.to_segmentation = nn.Sequential(
            nn.Conv3d(4 * decoder_dim, decoder_dim, 1, groups=decoder_dim),
...
if __name__ == '__main__': 
    ...
    for i in range(101):
        start = time.time()
        input = torch.rand(2,1,128,128,128).to(device)
